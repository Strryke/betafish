...
// Piece definitions --> if x == PIECES.bK checks for the black king
const PIECES = {
  EMPTY: 0,
  wP: 1,
  wN: 2,
...
// Files are the columns on the board
const FILES = {
  FILE_A: 0,
  FILE_B: 1,
  FILE_C: 2,
...
// Ranks are the rows on the board
const RANKS = {
  RANK_1: 0,
  RANK_2: 1,
  RANK_3: 2,
...
// Given a file and rank, which square are you on?
